...
public class OrderApiController {
    ...
    static class OrderDto {
        ...
        private List<OrdetItemDto> orderItems;
        ...
        public OrderDto(Order order) {
            ...
            orderItems = order.getOrderItems().stream().map(orderItem -> new OrdetItemDto(orderItem)).collect(Collectors.toList());

        }
    }

    @Getter
    static class OrdetItemDto {
        private String itemName;
        private int orderPrice;
        private int count;

        public OrdetItemDto(OrderItem orderItem) {
